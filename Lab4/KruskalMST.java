...
public class KruskalMST {
    ...
    private int numHeapComp, numUnionFind;		  // required measurements
    ...
    public KruskalMST(EdgeWeightedGraph G) {
        ...
        while (!pq.isEmpty() && mst.size() < G.V() - 1) {
            ...
            if (!uf.connected(v, w)) { // v-w does not create a cycle
                ...
                //ufCounter += uf.getConnectedCounter();
                //System.out.println(uf.getConnectedCounter());
            }
        }
        // get the required measurements after building MST
        numHeapComp = pq.getComp();
        numUnionFind = uf.getFind();
