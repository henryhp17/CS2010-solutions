...
public class AdjListGraph {
    ...
    public int sizeOfGraph() {
			//YOUR CODE HERE
        return numInt * Size.INTEGER + numRef * Size.REFERENCE;
    }
    ...
    public void addEdge(int v, int w) {
        ...
        validateVertex(w);
        E++;
        // Add integer and reference size when adding nodes of edges
        adj[v].add(w); numInt++; numRef++;
        adj[w].add(v); numInt++; numRef++;
    }
